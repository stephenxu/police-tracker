...
public class FT311UARTInterface extends Activity
{
	...
	private static final String ACTION_USB_PERMISSION =    "com.stephen.police.USB_PERMISSION";	
	...
	public static String ModelString1 = "mModel=Tracker Alert";
	...
	public void DestroyAccessory(boolean bConfiged){
		...
		{
			SetConfig(2400,(byte)1,(byte)8,(byte)0,(byte)0);  // send default setting data for config
			try{Thread.sleep(10);}
			catch(Exception e){}
